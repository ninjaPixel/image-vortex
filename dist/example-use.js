...
var readableStream = fs.createReadStream('./input.jpg');
var writableStream = fs.createWriteStream('averyuniquename.jpg');

// ImageVortex.resizeImage(readableStream, writableStream);
ImageVortex.imageDimensions('input.jpg').then(function (meta) {
